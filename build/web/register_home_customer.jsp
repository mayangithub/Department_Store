    ...
    <body>
        ...
        <div align="center">
            <form method="post" action="register_home_customer.jsp">
                ...
                <p>Age: 
                <input type='text' id='age' name="age" placeholder='Age' /></p><br>
                <p>Marriage Status: 
                <input type='radio' value='married' name="marriage"> Married   
                <input type='radio' name='marriage' value="single"> Single</p><br>
                <p>Income: 
                <input type='number' name="income" placeholder="Numeric Value" /></p><br>
                ...
                <a href="login_home_customer.jsp">
                        <button class="btn btn-large" type="button">Existing Home Customer Login~</button><p>
